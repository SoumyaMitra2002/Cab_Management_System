...
<form action="<%=request.getContextPath() %>/admin/cabupdate" method="post" enctype="multipart/form-data">
    <div class="wrapper">
        <div class="title">
            Update Details
        </div>
        <div class="form">
            <div class="inputfield">
                ...
                <input type="text" class="input" name="perkmrate" value="<%= cab.getPerKmRate() %>" required>
            </div>
           
            <div class="inputfield">
                <label>Cab Type</label>
                <div class="custom_select">
                    <select name="cabtype" required="required" value="<%= cab.getCabType() %>">
			...
			<input type="hidden" name="id" value="<%= cab.getCabId() %>">
