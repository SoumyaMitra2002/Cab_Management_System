...
<div class="container-header">
  ...
  <a href="<%=request.getContextPath() %>/admin/adddriver" class="btn btn-success add-employee-btn"><i class="bi-person-plus-fill"></i> Add Driver </a>
</div>

<%
List<Driver> list= (List<Driver>)request.getAttribute("drivers");
String name=(String)request.getAttribute("temp");
...
<div class="container text-center" style="width: 800px; margin-top: 5px;">
	...
	<%String rs= (String)request.getAttribute("update");%>
    ...
    else if(rs.equals("deleted")){
    %>
      <div class="alert" role="alert" id="myAlert" style="background-color:red; color:black ;">
  ...
  <table class="table">
   ...
   %>
    ...
    <tr>
      ...
      <td>
        <a href="<%=request.getContextPath() %>/admin/aboutdriver/<%=d.getDriverId() %>" class="btn btn-primary"><i class="bi-eye-fill"></i> View</a>
        <a href="<%=request.getContextPath() %>/admin/editdriver/<%=d.getDriverId() %>" class="btn btn-warning"><i class="bi-pencil-square"></i> Edit</a>
        <a id="<%=deleteButtonId %>" href="<%=request.getContextPath() %>/admin/deletedriver/<%=d.getDriverId()%>" class="btn btn-danger"
