...
<form  action="driverprocess" method="post"  enctype="multipart/form-data">
    <div class="wrapper">
        <div class="title">
            Registration Form
        </div>
        <div class="form">
            ...
            <div class="inputfield">
                ...
                <input type="text" class="input" name="licenceno" required>
            </div>
            ...
            <div class="inputfield">
                ...
                <input type="number" class="input" name="perkmrate" required>
            </div>
            ...
            <div class="inputfield">
                ...
                <div class="custom_select">
                    <select name="cab">
                        ...
                        <option value="Sadan">Saden</option>
        ...
        <script>
            ...
            Swal.fire({
                icon: 'error',
                title: 'ERROR',
                text: 'JPG AND JEPG FILES ARE ALLOWED',
            });
        </script>
