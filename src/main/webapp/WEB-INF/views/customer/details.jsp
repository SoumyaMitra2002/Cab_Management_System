...
<div class="employeeImg-wrapper"
    ...
    <img src="<%=request.getContextPath()%>/images/<%= customer.getImage().getId()%>" alt="Your Image"
...
<div class="box-wrapper">
    <div class="box">
        ...
        <h3 class="box-content"
            style="font-family: 'Times New Roman', Times, serif;"> <%= customer.getUsername() %>
        </h3>
    </div>
    <div class="box">
        <span class="box-header">Customer Id</span>
        <h3 class="box-content"
            style="font-family: 'Times New Roman', Times, serif;"><%= customer.getCustomerId() %></h3>
    </div>
    <div class="box">
        <span class="box-header">Email Id</span>
        <h3 class="box-content"
            style="font-family: 'Times New Roman', Times, serif;"><%= customer.getEmail() %>
        </h3>
    </div>
    <div class="box">
        <span class="box-header">Mobile Number</span>
        <h3 class="box-content"
            style="font-family: 'Times New Roman', Times, serif;"><%= customer.getMobileNumber() %></h3>
    </div>

    <div class="box">
        <span class="box-header">No. of Trips</span>
        <h3 class="box-content"
            style="font-family: 'Times New Roman', Times, serif;"><%= customer.getTrips().size() %></h3>
    </div>
    <div class="box special">
        <span class="box-header">Address</span>
        <h3 class="box-content"
            style="font-family: 'Times New Roman', Times, serif;"><%= customer.getAddress() %></h3>
    </div>
